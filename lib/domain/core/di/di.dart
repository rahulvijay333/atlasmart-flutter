...
import 'package:atlasmart/infrastructure/customer/notification/notification_service_impl.dart';
...
void setupDI() {
  ...
  sl.registerLazySingleton<ManageOrderService>(
    () => ManageOrderServiceImpl(dio: sl<Dio>()),
  );
