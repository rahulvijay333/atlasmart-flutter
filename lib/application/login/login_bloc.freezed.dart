...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _LoginButtonClickEvent value)?  loginButtonClickEvent,TResult Function( _LogOutButtonClick value)?  logOutButtonClick,required TResult orElse(),}){
final _that = this;
switch (_that) {
case _LoginButtonClickEvent() when loginButtonClickEvent != null:
return loginButtonClickEvent(_that);case _LogOutButtonClick() when logOutButtonClick != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _LoginButtonClickEvent value)  loginButtonClickEvent,required TResult Function( _LogOutButtonClick value)  logOutButtonClick,}){
final _that = this;
switch (_that) {
case _LoginButtonClickEvent():
return loginButtonClickEvent(_that);case _LogOutButtonClick():
return logOutButtonClick(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _LoginButtonClickEvent value)?  loginButtonClickEvent,TResult? Function( _LogOutButtonClick value)?  logOutButtonClick,}){
final _that = this;
switch (_that) {
case _LoginButtonClickEvent() when loginButtonClickEvent != null:
return loginButtonClickEvent(_that);case _LogOutButtonClick() when logOutButtonClick != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String email,  String password)?  loginButtonClickEvent,TResult Function()?  logOutButtonClick,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LoginButtonClickEvent() when loginButtonClickEvent != null:
return loginButtonClickEvent(_that.email,_that.password);case _LogOutButtonClick() when logOutButtonClick != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String email,  String password)  loginButtonClickEvent,required TResult Function()  logOutButtonClick,}) {final _that = this;
switch (_that) {
case _LoginButtonClickEvent():
return loginButtonClickEvent(_that.email,_that.password);case _LogOutButtonClick():
return logOutButtonClick();case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( String email,  String password)?  loginButtonClickEvent,TResult? Function()?  logOutButtonClick,}) {final _that = this;
switch (_that) {
case _LoginButtonClickEvent() when loginButtonClickEvent != null:
return loginButtonClickEvent(_that.email,_that.password);case _LogOutButtonClick() when logOutButtonClick != null:
return logOutButtonClick();case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( AuthTokens tokens)?  success,TResult Function( String message)?  failure,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( AuthTokens tokens)  success,required TResult Function( String message)  failure,}) {final _that = this;
switch (_that) {
case _Initial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( AuthTokens tokens)?  success,TResult? Function( String message)?  failure,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading();case _Success() when success != null:
